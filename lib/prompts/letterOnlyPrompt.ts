export const LETTER_ONLY_PROMPT = `Du formulierst einen sachlichen, bestimmten Antwortbrief an eine Behörde nach festgestellten Verstößen gegen das IV. Genfer Abkommen (GA IV).
